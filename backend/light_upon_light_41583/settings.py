"""
Django settings for light_upon_light_41583 project.
...
ROOT_URLCONF = 'light_upon_light_41583.urls'
...
WSGI_APPLICATION = 'light_upon_light_41583.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "light_upon_light_41583 API",
    "DESCRIPTION": "API documentation for light_upon_light_41583 App",
    "VERSION": "v1",
}
